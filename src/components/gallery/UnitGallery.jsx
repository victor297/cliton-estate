...
import AddUnitVideos from "../dashboard/AddUnitVideos";
import AddFloorPlan from "../dashboard/AddFloorPlan";
...
const UnitGallery = ({ unitId, fileType }) => {
  const [refreshKey, setRefreshKey] = useState(0);
  const [deleting, setDeleting] = useState("");

  // const { projectImages, project3DImages, projectVideos } = useGetOneProject(
  //   projectId,
  //   refreshKey
  // );

  const { loading, floorPlanImages, unitVideos } = useGetOneUnit(
    unitId,
    refreshKey
  );
